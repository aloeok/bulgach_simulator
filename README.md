...
**Номера задач, для которых готовы тесты:**
	...
	0276		0278		0283-001	0283-002	0283-003
	
	0284-001	0284-002	0284-003	0284-004	0284-005



# 1. Как использовать
- Поместите всё содержимое папки `src` в ту же папку на вашем компьютере, где лежат файлы с **исходным кодом** ваших решений
